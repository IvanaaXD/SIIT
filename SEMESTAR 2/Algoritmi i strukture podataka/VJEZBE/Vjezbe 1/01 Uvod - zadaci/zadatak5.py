...
def eratosthenes_sieve_simple(n):
    """
...
def eratosthenes_sieve_optimized(n):
    """
...
def main():
    ...
    start_time = time.time()
    primes = eratosthenes_sieve_simple(MAX_VALUE)
    result = sum(primes)
    end_time = time.time()
    ...
    start_time = time.time()
    primes = eratosthenes_sieve_optimized(MAX_VALUE)
    result = sum(primes)
    end_time = time.time()
