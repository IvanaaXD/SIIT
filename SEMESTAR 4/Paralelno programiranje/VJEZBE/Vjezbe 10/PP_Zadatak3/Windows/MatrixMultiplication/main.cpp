...
using namespace std;
//NOTE: Obratiti pažnju na kolièinu memorije koja se dinamièki zauzima.
...
int main (int argc, const char** argv)
{
	...
	size_t local_work_size[2] = { WORKGROUP_M, WORKGROUP_N };
	...
	print_matrix(host_buffer_C, M, N, "ORIGINAL");
	print_matrix(test_buffer_C, M, N, "TEST");
