...
# (videti komandu basename). Na primer, ako se izvorna je izvorna datoteka helloworld.cpp
...
#
# Napomene:
#   - Svaku datoteku prilo\enu uy yadatak je moguce kompajlirati komandom 
#       g++ <dat.cpp> -o <dat>
...
if [ ! -d $tdir ]; then
    ...
    echo "Greska. Korisnik nema pravo pitanja u $tdir direktorijum."
else
    cd $tdir;
    for d in $(ls *.cpp); do
