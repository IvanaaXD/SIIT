...
class RobotGame:
    ...
    def __init__(self, rows=20, cols=20, board_file_path='boards/board.brd', default_search="BFS"):
        ...
        self.canvas.bind('<Button-2>', self.switch_cell_backwards)  # bind left mouse click event to function switch_cell
    ...
    def do_search(self):
        ...
        self.path, self.processed, states = search.search(initial_state)
